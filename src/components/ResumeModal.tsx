          ...
          <div className="mx-auto w-full max-w-[800px] bg-white text-black p-6 sm:p-10 md:p-12 shadow-md border border-zinc-300 dark:border-zinc-700 rounded-sm font-serif text-[13px] leading-snug select-text mb-8">
            ...
            <section className="mb-3.5">
              ...
              <div>
                ...
                <div className="flex justify-between items-baseline text-xs text-zinc-900 font-serif mb-0.5">
                  <span className="italic">Bachelor of Science in Electrical Engineering</span>
                  <span className="not-italic font-sans text-xs text-zinc-700 font-medium">2019-2023</span>
                </div>
                ...
                <p className="text-[11px] leading-relaxed text-zinc-900 font-sans mt-0.5">
                  ...
                  <a
                    href="https://lance-portfolio.lnguyen9152.workers.dev"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-blue-700 hover:underline"
                  >
                    lance-portfolio.lnguyen9152.workers.dev
                  </a>
                </p>
              </div>
            </section>
            ...
            <section className="mb-3.5">
              ...
              <div className="mb-3">
                ...
                {/* Role 1 */}
                <div className="mt-1">
                  <div className="flex justify-between items-baseline text-xs text-zinc-900 font-serif">
                    <span className="italic">Ground Support Equipment Engineer II – Avionics Test</span>
                    <span className="not-italic font-sans text-xs text-zinc-700 font-medium">2026-Present</span>
                  </div>
                  <ul className="mt-1 space-y-1 text-[11px] leading-snug text-zinc-900 list-disc list-outside pl-4 font-sans">
                    <li>Lead engineer for the design, integration, and ongoing development of high-reliability ground support systems, ensuring mission readiness and supporting Terran R&apos;s integration, test, and launch phases.</li>
                    <li>Design and deliver Engine Checkout Racks to the propulsion team, ensuring robust testing and validation of flight engines with &lt;1 µs accuracy.</li>
                ...
                <div className="mt-2">
                  <div className="flex justify-between items-baseline text-xs text-zinc-900 font-serif">
                    <span className="italic">Data and Controls Engineer II – Factory Test</span>
                    <span className="not-italic font-sans text-xs text-zinc-700 font-medium">2025-2026</span>
                  </div>
                  <ul className="mt-1 space-y-1 text-[11px] leading-snug text-zinc-900 list-disc list-outside pl-4 font-sans">
              ...
              <div className="mb-3">
                ...
                <div className="mt-1">
                  <div className="flex justify-between items-baseline text-xs text-zinc-900 font-serif">
                    <span className="italic">Instrumentation, Controls, and Electrical Engineer – Production and Operations</span>
                    <span className="not-italic font-sans text-xs text-zinc-700 font-medium">2023-2025</span>
                  </div>
                  <ul className="mt-1 space-y-1 text-[11px] leading-snug text-zinc-900 list-disc list-outside pl-4 font-sans">
              ...
              <div className="mb-3">
                ...
                <div className="mt-1">
                  <div className="flex justify-between items-baseline text-xs text-zinc-900 font-serif">
                    ...
                    <span className="not-italic font-sans text-xs text-zinc-700 font-medium">2021-2022</span>
                  </div>
                  <ul className="mt-1 space-y-1 text-[11px] leading-snug text-zinc-900 list-disc list-outside pl-4 font-sans">
            ...
            <section>
              ...
              <p className="text-[11px] leading-relaxed text-zinc-900 font-sans">
                ...
                Java, Python, MatLab, Simulink, Verliog, Assembly, Ladder Logic, Functional Block, Structured Text
              </p>
              <p className="text-[11px] leading-relaxed text-zinc-900 font-sans mt-1">
