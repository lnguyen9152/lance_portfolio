    ...
    <section id="about-section" className="space-y-8 animate-in fade-in duration-300">
      ...
      <div className="border-b border-[#1A1A1A]/20 dark:border-zinc-800 pb-4">
        ...
        <p className="text-xs md:text-sm text-[#1A1A1A]/60 dark:text-zinc-400 mt-1 font-serif italic">
          Academic credentials, rigorous electrical engineering coursework, and technical literature interests.
        </p>
      </div>

      {/* Expanded Narrative */}
      <div className="space-y-3 text-sm md:text-base text-[#1A1A1A]/80 dark:text-zinc-300 leading-relaxed font-sans bg-[#FDFDFB] dark:bg-[#181816] p-6 rounded-sm border border-[#1A1A1A]/15 dark:border-zinc-800">
        {PERSONAL_INFO.bioLong.map((para, i) => (
          <p key={i}>{para}</p>
        ))}
      </div>
